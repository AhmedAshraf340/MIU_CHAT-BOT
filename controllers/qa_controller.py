...
class QAController:
    __intents = json.loads(open('C:/Users/Ahmed/Desktop/chatbot/chatbot-deployment-main/dataset/intents.json', encoding = "utf8").read())
    __words = pickle.load(open('C:/Users/Ahmed/Desktop/chatbot/chatbot-deployment-main/dataset/words.pkl','rb'))
    __classes = pickle.load(open('C:/Users/Ahmed/Desktop/chatbot/chatbot-deployment-main/dataset/classes.pkl','rb'))

    __lemmatizer = WordNetLemmatizer()
    __model = load_model('C:/Users/Ahmed/Desktop/chatbot/chatbot-deployment-main/dataset/chatbot_model.h5')
    ...
    def __getResponse(self, ints, intents_json):
        try:
            ...
            result ="I Don't understand,Please elaborate"
        return result
